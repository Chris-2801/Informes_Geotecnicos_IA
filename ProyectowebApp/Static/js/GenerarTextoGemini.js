...
//Configuración secciones html subir_imagen
...
// Función para mostrar secciones
      ...
      window.onload = () => {
        ...
        // Confirmación antes de salir al hacer clic en "Esclerometro"
        const esclerometroBtn = document.getElementById("btn-esclerometro");
        if (esclerometroBtn) {
          esclerometroBtn.addEventListener("click", function (event) {
        ...
        const validacionBtn = document.getElementById("btn-validacion");
        if (validacionBtn) {
          validacionBtn.addEventListener("click", function (event) {
            const salir = confirm("¿Deseas salir de la página de edición? Los datos no guardados se perderán.");
            if (!salir) {
        ...
        const triaxialBtn = document.getElementById("btn-triaxial");
        if (triaxialBtn) {
          triaxialBtn.addEventListener("click", function (event) {
            const salir = confirm("¿Deseas salir de la página de edición? Los datos no guardados se perderán.");
            if (!salir) {
              event.preventDefault(); // evita que se redirija
            }
